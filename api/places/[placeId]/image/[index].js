/**
 * Vercel Serverless: GET /api/places/:placeId/image/:index — прокси изображения с Яндекс.Диска (тот же origin, картинки открываются на хосте).
...
/**
 * Получить временную ссылку на скачивание файла по пути на Диске.
 */
...
/**
 * Стрим ответа по URL в res с заданным Content-Type.
 */
